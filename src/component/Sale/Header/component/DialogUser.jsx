...
const DialogUser = () => {
  return (
    <div className="w-[300px] top-16 right-0 z-10 fixed h-[260px] bg-[#fff] mr-10 border-2 border-gray-300 rounded-[5px] flex-col justify-center">
      ...
      <div className="mt-2 mx-1">
        <div className="flex hover:bg-gray-200 cursor-pointer p-1">
          ...
          <p className="font-sans text-[16px] font-medium ml-2 mt-1">Thêm món ăn mới</p>
        </div>
        ...
        <div className="flex mt-2 hover:bg-gray-200 cursor-pointer p-1">
          ...
          <p className="font-sans text-[16px] font-medium ml-2 mt-1">Đăng xuất</p>
        </div>
      </div>
    </div>
  );
